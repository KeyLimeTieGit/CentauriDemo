...
//        indicator.backgroundColor = [UIColor colorWithRed:0.478 green:0.761 blue:0.741 alpha:1.00];
	}
...
- (void)layoutSubviews {
	...
	//(DEP)CGSize labelSize = [label.text sizeWithFont:label.font];
	...
	//(DEP)CGSize detailsLabelSize = [detailsLabel.text sizeWithFont:detailsLabel.font constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
